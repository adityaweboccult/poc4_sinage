...
class Predictor:
    def __init__(self, config, verbose: bool = False):
        ...
        print('Config checkpoints', config.checkpoint)
    ...
    def custom_recognize(self,detected_objects, image: np.ndarray) -> Tuple[PersonAndFaceResult, Optional[np.ndarray]]:
        # detected_objects: PersonAndFaceResult = self.detector.predict(image)
        age_output,gender_output = self.age_gender_model.custom_predict(image, detected_objects)
